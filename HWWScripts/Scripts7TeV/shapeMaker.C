...
void shapeMaker(float lumi=4.7, int njets=0, int mass=130, TString fs="sffs", TString plotvar="bdtg") {
  ...
  sigreg_himet.ReplaceAll("=minmetvtx=","=mmvtxallfs=");//fixme
  ...
  fillPlot(plotvar,zz_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,ttbar_var_h, dir+"ttbar_mg"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  //fillPlot(plotvar,wgfo_h, main_dir+wj_dir+"wgamma_lgamma"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw,"wgammafo");
  ...
  if (fs.Contains("sffs")) {
    ...
    fillPlot(plotvar,dymm_vtx_h, dir+"dymm"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
    fillPlot(plotvar,dyee_vtx_h, dir+"dyee"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
    zjets_h_old_up->Add(dymm_vtx_h);
    zjets_h_old_up->Add(dyee_vtx_h);
  ...
  */
  ...
  if (fs.Contains("sffs")) {
    ...
    scaleIntegral(zjets_h,zjets_h_up_himet);
  }
  */
  ...
  if (fs.Contains("sffs")) {
    ...
    scaleIntegral(zjets_h,zjets_h_up_zeta);
  }
  */
  ...
  fillPlot(plotvar,ztt_h, dir+"dytt"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ztt_h->Add(dytt_h);
  ...
  fillPlot(plotvar,ttbarfake_e_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_e_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,wg3lfake_e_h,dirwj+"wg3l"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dymmfake_e_h = new TH1F("dymmfake_e","dymmfake_e",nbins,minx,maxx);
  fillPlot(plotvar,dymmfake_e_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyeefake_e_h = new TH1F("dyeefake_e","dyeefake_e",nbins,minx,maxx);
  fillPlot(plotvar,dyeefake_e_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyttfake_e_h = new TH1F("dyttfake_e","dyttfake_e",nbins,minx,maxx);
  fillPlot(plotvar,dyttfake_e_h,dirwj+"dytt"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=elfake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  wjetsE_h->Add(dymmfake_e_h,-1.);  
  wjetsE_h->Add(dyeefake_e_h,-1.);
  wjetsE_h->Add(dyttfake_e_h,-1.);
  ...
  */
  ...
  fillPlot(plotvar,ttbarfake_e_fr_up_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_e_fr_up_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,wg3lfake_e_fr_up_h,dirwj+"wg3l"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dymmfake_e_fr_up_h = new TH1F("dymmfake_e_fr_up","dymmfake_e_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dymmfake_e_fr_up_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyeefake_e_fr_up_h = new TH1F("dyeefake_e_fr_up","dyeefake_e_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dyeefake_e_fr_up_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyttfake_e_fr_up_h = new TH1F("dyttfake_e_fr_up","dyttfake_e_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dyttfake_e_fr_up_h,dirwj+"dytt"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=elfake=", lumi, useJson, applyEff, true, doPUw);
  ...
  wjetsE_fr_up_h->Add(dymmfake_e_fr_up_h,-1.);
  wjetsE_fr_up_h->Add(dyeefake_e_fr_up_h,-1.);
  wjetsE_fr_up_h->Add(dyttfake_e_fr_up_h,-1.);
  ...
  fillPlot(plotvar,ttbarfake_m_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_m_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,wg3lfake_m_h,dirwj+"wg3l"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dymmfake_m_h = new TH1F("dymmfake_m","dymmfake_m",nbins,minx,maxx);
  fillPlot(plotvar,dymmfake_m_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyeefake_m_h = new TH1F("dyeefake_m","dyeefake_m",nbins,minx,maxx);
  fillPlot(plotvar,dyeefake_m_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyttfake_m_h = new TH1F("dyttfake_m","dyttfake_m",nbins,minx,maxx);
  fillPlot(plotvar,dyttfake_m_h,dirwj+"dytt"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=mufake=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  wjetsM_h->Add(dymmfake_m_h,-1.);
  wjetsM_h->Add(dyeefake_m_h,-1.);
  wjetsM_h->Add(dyttfake_m_h,-1.);
  ...
  */
  ...
  fillPlot(plotvar,ttbarfake_m_fr_up_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_m_fr_up_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,wg3lfake_m_fr_up_h,dirwj+"wg3l"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dymmfake_m_fr_up_h = new TH1F("dymmfake_m_fr_up","dymmfake_m_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dymmfake_m_fr_up_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyeefake_m_fr_up_h = new TH1F("dyeefake_m_fr_up","dyeefake_m_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dyeefake_m_fr_up_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  TH1F* dyttfake_m_fr_up_h = new TH1F("dyttfake_m_fr_up","dyttfake_m_fr_up",nbins,minx,maxx);
  fillPlot(plotvar,dyttfake_m_fr_up_h,dirwj+"dytt"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=alternativeFR=mufake=", lumi, useJson, applyEff, true, doPUw);
  ...
  wjetsM_fr_up_h->Add(wgfake_m_fr_up_h,-1.);
  wjetsM_fr_up_h->Add(wg3lfake_m_fr_up_h,-1.);
  wjetsM_fr_up_h->Add(dymmfake_m_fr_up_h,-1.);
  wjetsM_fr_up_h->Add(dyeefake_m_fr_up_h,-1.);
  wjetsM_fr_up_h->Add(dyttfake_m_fr_up_h,-1.);
  ...
  */
  ...
  if (doResEffSyst) {
    ...
    fillPlot(plotvar,zz_metres_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "metSmear");
    ...
    */
    ...
    fillPlot(plotvar,zz_lepres_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleUp");
    ...
    fillPlot(plotvar,zz_lepres_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleDown");
    ...
    */
    ...
    fillPlot(plotvar,zz_jes_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesUp");
    ...
    fillPlot(plotvar,zz_jes_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesDown");
    ...
    */
    ...
    fillPlot(plotvar,zz_lepeff_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffUp");
    ...
    fillPlot(plotvar,zz_lepeff_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffDown");
