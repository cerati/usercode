...
void shapeMaker(float lumi=4.7, int njets=0, int mass=130, TString fs="sffs", TString plotvar="bdtg") {
  ...
  sigreg_lowmet.ReplaceAll("=minmetvtx=","=met2040=");//fixme
  ...
  fillPlot(plotvar,qqww_mcnlo_up_h, dir+"ww_mcnlo_up"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,qqww_mcnlo_down_h, dir+"ww_mcnlo_down"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,zz_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,ttbar_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,tw_ds_h, dir+"tw_ds"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);//fixme tw_ds
  ...
  fillPlot(plotvar,wg3l_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,dyll_lowmet_h, dirdy+"dymm"+suffix, wwSelNoMet, veto, mass, njets, sigreg_lowmet+fs, lumi, useJson, applyEff, doFake, doPUw);
  fillPlot(plotvar,dyll_lowmet_h, dirdy+"dyee"+suffix, wwSelNoMet, veto, mass, njets, sigreg_lowmet+fs, lumi, useJson, applyEff, doFake, doPUw);
  TH1F* dyll_vtx_h = new TH1F("histo_dyll_vtx","histo_dyll_vtx",nbins,minx,maxx);
  fillPlot(plotvar,dyll_vtx_h, dir+"dymm"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  fillPlot(plotvar,dyll_vtx_h, dir+"dyee"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  fillPlot(plotvar,pzz_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=fromZ="+fs, lumi, useJson, applyEff, doFake, doPUw);
  ...
  TH1F* zjets_h_old_up = new TH1F(Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingUp",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),
				  Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingUp",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),nbins,minx,maxx);
  TH1F* zjets_h_old_down = new TH1F(Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingDown",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),
  ...
  TH1F* zjets_h_up = new TH1F(Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingUpNew",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),
			      Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingUpNew",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),nbins,minx,maxx);
  TH1F* zjets_h_down = new TH1F(Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingDownNew",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),
				Form("histo_Zjets_CMS_hww%s_%ij_MVAZBoundingDownNew",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets),nbins,minx,maxx);
  /*
  if (fs.Contains("sffs")) {
    ...
    fillPlot(plotvar,zz_lowmet_new_h, dirdy+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg_lowmet+"=sffs=", lumi, useJson, applyEff, doFake, doPUw,"");
  ...
  */
  ...
  if (fs.Contains("sffs")) {
    ...
    fillPlot(plotvar,zz_himet_h, dirdy+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg_himet+"=sffs=", lumi, useJson, applyEff, doFake, doPUw,"");
  ...
  */
  ...
  if (fs.Contains("sffs")) {
    ...
    fillPlot(plotvar,zz_lowmet_zeta_h, dirdy+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg_lowmet+"=sffs=", lumi, useJson, applyEff, doFake, doPUw,"");
  ...
  */
  ...
  fillPlot(plotvar,ttbarfake_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,dyllfake_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=spill=", lumi, useJson, applyEff, true, doPUw);
  fillPlot(plotvar,dyllfake_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+fs+"=spill=", lumi, useJson, applyEff, true, doPUw);
  ...
  */
  ...
  fillPlot(plotvar,ttbarfake_fr_up_h,dirwj+"ttbar"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+"=alternativeFR="+fs, lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,zzfake_fr_up_h,dirwj+"zz_py"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+"=alternativeFR="+fs, lumi, useJson, applyEff, true, doPUw);
  ...
  fillPlot(plotvar,dyllfake_fr_up_h,dirwj+"dymm"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+"=alternativeFR="+fs, lumi, useJson, applyEff, true, doPUw);
  fillPlot(plotvar,dyllfake_fr_up_h,dirwj+"dyee"+suffix, wwSelNoMetNoLep, veto, mass, njets, sigreg+"=alternativeFR="+fs, lumi, useJson, applyEff, true, doPUw);
  ...
  if (doResEffSyst) {
    ...
    fillPlot(plotvar,zz_metres_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "metSmear");
    ...
    fillPlot(plotvar,ttbar_metres_up_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "metSmear");
    ...
    fillPlot(plotvar,wg3l_metres_up_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "metSmear");
    ...
    fillPlot(plotvar,zz_lepres_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleUp");
    ...
    fillPlot(plotvar,zz_lepres_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleDown");
    ...
    fillPlot(plotvar,ttbar_lepres_up_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleUp");
    ...
    fillPlot(plotvar,ttbar_lepres_down_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleDown");
    ...
    fillPlot(plotvar,wg3l_lepres_up_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleUp");
    ...
    fillPlot(plotvar,wg3l_lepres_down_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "momScaleDown");
    ...
    fillPlot(plotvar,zz_jes_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "jesUp");
    ...
    fillPlot(plotvar,zz_jes_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "jesDown");
    ...
    fillPlot(plotvar,ttbar_jes_up_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesUp");
    ...
    fillPlot(plotvar,ttbar_jes_down_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesDown");
    ...
    fillPlot(plotvar,wg3l_jes_up_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesUp");
    ...
    fillPlot(plotvar,wg3l_jes_down_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "jesDown");
    ...
    fillPlot(plotvar,zz_lepeff_up_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffUp");
    ...
    fillPlot(plotvar,zz_lepeff_down_h, dir+"zz_py"+suffix, wwSelNoMet, veto, mass, njets, sigreg+"=notZ="+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffDown");
    ...
    //fillPlot(plotvar,ttbar_lepeff_up_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffUp");
    ...
    //fillPlot(plotvar,ttbar_lepeff_down_h, dir+"ttbar"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffDown");
    ...
    fillPlot(plotvar,wg3l_lepeff_up_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffUp");
    ...
    fillPlot(plotvar,wg3l_lepeff_down_h, dir+"wg3l"+suffix, wwSelNoMet, veto, mass, njets, sigreg+fs, lumi, useJson, applyEff, doFake, doPUw, "lepeffDown");
...
//   printBins(wjets_mc_down_h);
 ...
 //Write histos to file
  TString outfname = Form("hww%s_%ij.input_7TeV.root",TString(fs).ReplaceAll("fs","").ReplaceAll("=","").Data(),njets);
