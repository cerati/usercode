...
echo 'processing mass='\${MASS} analysis ${ANA} $NJET jet>> /tmp/cerati/CMSSW_5_3_3/src/log_\${INJ}_\${MASS}_\${MIN}_\${MAX}_$ANA_summary.log
for NEXP in \$(seq \${MIN} \${MAX})
  ...
  python ../../../HiggsAnalysis/CombinedLimit/test/mlfitNormsToText.py mlfit.root >> /tmp/cerati/CMSSW_5_3_3/src/logNorm_\${INJ}_\${MASS}_${ANA}of_0j_shape_8TeV_\${MIN}_\${MAX}.log
  python ../../../HiggsAnalysis/CombinedLimit/test/diffNuisances.py -a mlfit.root >> /tmp/cerati/CMSSW_5_3_3/src/logNuis_\${INJ}_\${MASS}_${ANA}of_0j_shape_8TeV_\${MIN}_\${MAX}.log
  cp mlfit.root /tmp/cerati/CMSSW_5_3_3/src/mlfit_injm${INJ}_m\${MASS}_${ANA}of_0j_id\${NEXP}.root 
  ...
  python ../../../HiggsAnalysis/CombinedLimit/test/mlfitNormsToText.py mlfit.root >> /tmp/cerati/CMSSW_5_3_3/src/logNorm_\${INJ}_\${MASS}_${ANA}of_1j_shape_8TeV_\${MIN}_\${MAX}.log
  python ../../../HiggsAnalysis/CombinedLimit/test/diffNuisances.py -a mlfit.root >> /tmp/cerati/CMSSW_5_3_3/src/logNuis_\${INJ}_\${MASS}_${ANA}of_1j_shape_8TeV_\${MIN}_\${MAX}.log
  cp mlfit.root /tmp/cerati/CMSSW_5_3_3/src/mlfit_injm${INJ}_m\${MASS}_${ANA}of_1j_id\${NEXP}.root 
  rm mlfit.root higgsCombineTest.MaxLikelihoodFit.mH125.root
...
cp /tmp/cerati/CMSSW_5_3_3/src/log* $OUTPUTDIR/logsNorm/\${MASS}/
cp /tmp/cerati/CMSSW_5_3_3/src/mlfit_* $OUTPUTDIR/logsNorm/\${MASS}/
cd /tmp/cerati/
rm -rf CMSSW_5_3_3
EOF
